...
impl HTMLIFrameElement {
    ...
    fn navigate_to_the_srcdoc_resource(&self, mode: ProcessingMode, cx: &mut JSContext) {
        ...
        load_data.credentialless = self.Credentialless();
...
impl HTMLIFrameElementMethods<crate::DomTypeHolder> for HTMLIFrameElement {
    ...
    // https://html.spec.whatwg.org/multipage/#attr-iframe-credentialless
    fn Credentialless(&self) -> bool {
        self.upcast::<Element>()
            .has_attribute(&LocalName::from("credentialless"))
    }
    // https://html.spec.whatwg.org/multipage/#attr-iframe-credentialless
    fn SetCredentialless(&self, cx: &mut JSContext, value: bool) {
        self.upcast::<Element>()
            .set_bool_attribute(cx, &LocalName::from("credentialless"), value)
    }
