...
pub(crate) fn prepare_workerscope_init(
    ...
    WorkerGlobalScopeInit {
        ...
        top_level_creation_url: global.top_level_creation_url().clone(),
        storage_partition_key: global.storage_partition_key().map(str::to_owned),
    ...
    pub(crate) fn new_inherited(
        ...
        Self {
            globalscope: GlobalScope::new_inherited(
                ...
                worker_url.clone(),
                init.top_level_creation_url,
                init.storage_partition_key,
                #[cfg(feature = "webgpu")]
                gpu_id_hub,
