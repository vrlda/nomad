    ...
    impl LogTarget for servo_constellation_traits::EmbedderToConstellationMessage {
        fn log_target(&self) -> &'static str {
            match self {
                ...
                Self::EvaluateJavaScript(..) | Self::EvaluateJavaScriptInPipeline(..) => {
                    target!("EvaluateJavaScript")
                },
                Self::CreateMemoryReport(..) => target!("CreateMemoryReport"),
                Self::CreateWebViewMemoryReport(..) => target!("CreateWebViewMemoryReport"),
                ...
                Self::AccessibilityAction(..) => target!("AccessibilityAction"),
            }
        }
    }
    ...
    impl LogTarget for servo_constellation_traits::ScriptToConstellationMessage {
        fn log_target(&self) -> &'static str {
            match self {
                ...
                Self::ServiceWorkerClientQuery { .. } => target!("ServiceWorkerClientQuery"),
                Self::ServiceWorkerClientFocus { .. } => target!("ServiceWorkerClientFocus"),
                Self::ServiceWorkerClientNavigate { .. } => target!("ServiceWorkerClientNavigate"),
                Self::ServiceWorkerClientPostMessage { .. } => {
                    target!("ServiceWorkerClientPostMessage")
                },
                Self::ServiceWorkerClaimClients { .. } => target!("ServiceWorkerClaimClients"),
                Self::ServiceWorkerControllerChanged { .. } => {
                    target!("ServiceWorkerControllerChanged")
                },
                Self::ServiceWorkerOpenWindow { .. } => target!("ServiceWorkerOpenWindow"),
                ...
                Self::GetTopLevelUrlForBrowsingContext(..) => {
                    target!("GetTopLevelUrlForBrowsingContext")
                },
