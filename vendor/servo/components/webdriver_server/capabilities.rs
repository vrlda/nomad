...
impl ServoCapabilities {
    pub(crate) fn with_identity(identity: &WebDriverIdentity) -> ServoCapabilities {
        ServoCapabilities {
            browser_name: identity.browser_name.clone(),
            browser_version: identity.browser_version.clone(),
            extra_capabilities: identity
                .extra_capabilities
                .iter()
