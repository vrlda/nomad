...
impl BrowsingContextActor {
    ...
    pub(crate) fn register(
        ...
        let storage_actor = StorageActor::register(registry, name.clone());
        ...
        let actor = BrowsingContextActor {
            ...
            storage_name: storage_actor.name().into(),
