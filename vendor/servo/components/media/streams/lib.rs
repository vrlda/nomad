...
pub trait MediaStream: Any + Send {
    ...
    /// Enable or disable delivery while keeping the track live.
    fn set_enabled(&mut self, _enabled: bool) {}
    /// Stop producing media while allowing owners that still hold a stream
    /// reference to release it normally.
    fn stop(&mut self) {}
}
