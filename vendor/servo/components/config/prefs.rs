...
pub struct Preferences {
    ...
    /// Nomad privacy policy: reject third-party cookies in network requests.
    pub network_nomad_block_third_party_cookies: bool,
    /// Nomad privacy policy: reduce cross-site referrers to their origin.
    pub network_nomad_reduce_cross_site_referrers: bool,
    /// Nomad privacy policy: partition network cookies by top-level site.
    pub network_nomad_partition_storage: bool,
...
impl Preferences {
    const fn const_default() -> Self {
        Self {
            ...
            network_nomad_block_third_party_cookies: false,
            network_nomad_reduce_cross_site_referrers: false,
            network_nomad_partition_storage: false,
