...
pub struct RequestClient {
    ...
    /// The top-level site partition used for storage and service-worker lookup.
    pub top_level_partition_key: Option<String>,
}
...
impl RequestBody {
    ...
    /// Returns known upload size without touching the streaming channel.
