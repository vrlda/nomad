...
pub struct CustomResponseMediator {
    ...
    /// Original request builder used to start navigation preload without
    /// re-entering service-worker interception.
...
pub enum CoreResourceMsg {
    ...
    GetCookieDataForUrlAsync(CookieStoreId, ServoUrl, ServoUrl, Option<String>),
    GetAllCookieDataForUrlAsync(CookieStoreId, ServoUrl, ServoUrl, Option<String>),
    ...
    DeleteCookieAsync(CookieStoreId, ServoUrl, ServoUrl, String),
    NewCookieListener(
        CookieStoreId,
