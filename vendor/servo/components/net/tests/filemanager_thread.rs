...
use net::test_util::create_generic_embedder_proxy;
...
#[test]
fn test_filemanager() {
    // The net test harness owns the process-wide async runtime. Initialize it
    // through the shared helper instead of racing its OnceLock directly.
